...
class TreeGrower:
    ...
    def __init__(self, dataset, gradients, hessians, options:OptionSet):
        ...
        self._validate_parameters(dataset.X_binned, self.max_leaf_nodes, self.max_depth,
        ...
        self.splitting_context = SplittingContext(
            dataset.X_binned, self.max_bins, self.n_bins_per_feature, gradients,
    ...
    def make_predictor(self):
        ...
        has_numerical_thresholds = self.numerical_thresholds is not None
